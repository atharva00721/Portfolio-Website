...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 1], [0, 750]);
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:pt-20 pb-100 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-0"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] absolute inset-0 bg-[#010101] rounded-2xl p-0"
      >
        <div className="absolute inset-0 bg-[#272729] rounded-lg" />
        <img
          src={
            "https://i.pinimg.com/564x/08/64/22/0864225457f329b6bc46f96a8dc3d331.jpg"
          }
          alt="aceternity logo"
          className="z-30 object-cover object-left-center absolute rounded-lg inset-0 h-full w-full bg-contain"
        />
      </motion.div>
    </div>
  );
